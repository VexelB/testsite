...
function guestcount(e) {
  var temps = e.parentNode.parentNode.childNodes;
  var count = 0;
  ...
  if (count > 0) {
    ...
    var q = e.parentNode.parentNode.childNodes;
...
;
var mins = document.querySelectorAll(".drop .min");
var maxs = document.querySelectorAll(".drop .max");

var _loop = function _loop(i) {
  mins[i].addEventListener('click', function (e) {
    var temp = parseInt(e.target.nextSibling.innerText);
  ...
  maxs[i].addEventListener('click', function (e) {
    var temp = parseInt(e.target.previousSibling.innerText);
    e.target.previousSibling.innerText = ++temp;
    mins[i].style.color = "rgba(31, 32, 65, 0.5)";
    mins[i].style.borderColor = "rgba(31, 32, 65, 0.5)";
    var q = e.target.parentNode.parentNode.parentNode.childNodes;
...
document.querySelectorAll(".drop .err").forEach(function (e) {
  return e.addEventListener("click", function (e) {
    var temp = e.target.parentNode.parentNode.childNodes;

    for (var _i = 0; _i < temp.length - 1; _i++) {
      temp[_i].lastChild.childNodes[1].innerText = "0";
      clear(temp[_i].lastChild.firstChild);
    }

    guestcount(e.target);
  });
});
document.querySelectorAll(".drop .suc").forEach(function (e) {
  return e.addEventListener("click", function (e) {
    return guestcount(e.target);
  });
});
...
},{}]},{},["../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/dropdown.js"], null)
